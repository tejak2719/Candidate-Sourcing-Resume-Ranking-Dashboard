...
st.title("🔗 End-to-End Sourcing → Scraping → Ranking")
...
# st.set_page_config(page_title="Sourcing → Ranking Pipeline", layout="wide")
# st.title("🔗 End-to-End Sourcing → Scraping → Ranking")

# tabs = st.tabs(["1️⃣ Skills → LinkedIn URLs", "2️⃣ Scrape Profiles", "3️⃣ Rank Profiles"])

# # -------------------------------------------------------------------------
# # TAB 1: Skills → URLs (Google actor)
# # -------------------------------------------------------------------------
# with tabs[0]:
#     st.header("1️⃣ Skills → Bulk LinkedIn Profile URLs")
...
#     skills_text = st.text_area("Paste 10–15 skills", "python\nkubernetes\nairflow\nspark\nsnowflake", height=150)
...
# # ________________________________________________________________________________________________________
# # sourcing_to_ranking.py — with full FRF inputs + session persistence
# # ________________________________________________________________________________________________________
# # ________________________________________________________________________________________________________
# import os
# import json
...
# # -------------------------------------------------------------------------
# # TAB 1: Skills → URLs (Google actor) + FULL FRF INPUTS
# # -------------------------------------------------------------------------
# with tabs[0]:
#     st.header("1️⃣ Skills → Bulk LinkedIn Profile URLs")
...
#     skills_text = st.text_area("Paste 10–15 skills (one per line)",
#                                "python\nkubernetes\nairflow\nspark\nsnowflake",
#                                height=150)
...
#     # Save FRF (in session + file) — runs when button is clicked below
#     def persist_frf():
#         frf = {
#             "band": band,
#             "experience": experience_choice,
